...
export default function FeatureContentBody() {
  ...
  const li2Opacity = useTransform(scrollYProgress, [0.45, 0.55], [0, 1]);
  ...
  return (
    <div className="w-full py-12 px-4 sm:px-6 lg:px-8 rounded-t-2xl flex flex-row justify-between">
      ...
      >
        <div className="flex flex-col items-center justify-center h-[50vh] w-[50vw] ml-4">
          <div className="flex flex-row mb-12 w-[60vw]">
            {/* Apply opacity transform to h1 element */}
            <motion.h1
              className="text-4xl font-medium mr-4"
