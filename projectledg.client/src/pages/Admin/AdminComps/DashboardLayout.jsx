...
const navItems = [
  ...
  { icon: Home, label: "Hem", path: "/admin/dashboard", position: "top", tooltipText: "Hem" },
  { icon: Activity, label: "Användarhanteraren", path: "/user-management", position: "top", tooltipText: "Användarhanteraren" },
...
const NavItem = ({ icon: Icon, label, path, onClick }) => {
  ...
  const fullPath = `/admin/dashboard`;
